// The copy of the contracts/UniswapV3Staker.sol
...
contract MockTimeUniswapV3Staker is IUniswapV3Staker, Multicall {
    // Added for tests.
    ...
    function _stakeToken(IncentiveKey memory key, uint256 tokenId) private {
        require(timeSimulator.blockTimestamp() >= key.startTime, 'UniswapV3Staker::stakeToken: incentive not started');
        require(timeSimulator.blockTimestamp() < key.endTime, 'UniswapV3Staker::stakeToken: incentive ended');
